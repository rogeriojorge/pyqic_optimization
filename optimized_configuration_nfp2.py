...
def optimized_configuration_nfp2(nphi=131,order = "r2"):
    ...
    k_buffer = 1
    p_buffer = 2
    d_over_curvature_cvals = [0.580044972561008,-0.16173713638269638,-0.07204934493020146,0,0,0]
    delta   = 0.1
    d_svals = []
    nfp     = 2
    ...
    X2s_svals = []
    X2c_cvals = [0.0]
    X2s_cvals = [-0.27271824369578124,1.408962185789325,0.029550485422345667,0,0,0,0]
    X2c_svals = [0.0,1.3985747409931824,1.9696375265576096,-0.05425156701114692,0,0,0,0]
    p2      = 0.0
