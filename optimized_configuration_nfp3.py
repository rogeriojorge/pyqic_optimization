...
def optimized_configuration_nfp3(nphi=131,order = "r2"):
    ...
    k_buffer = 1
    p_buffer = 2
    d_over_curvature_cvals = [0.6996215427705272,-0.26839194225777063,-0.04927968019298633,0,0,0]
    delta   = 0.1
    d_svals = []
    nfp     = 3
    ...
    X2s_svals = []
    X2c_cvals = [0.0]
    X2s_cvals = [-0.011131410883046108,3.3005667404508596,-1.5566823895346698,0,0,0,0]
    X2c_svals = [0.0,2.4980533005569265,0.9707302905374766,-0.4836693453391415,0,0,0,0]
    p2      = 0.0
